...
<div class="main">
    ...
    <div class="dl_jm">
        ...
        <div class="dl_jmbg dl_zhmm">
            <div class="dl_jm_label">找回密码</div>
            <div class="dl_jm_cont">
                <div class="dl_jm_one"><input name="email" type="text" id="email"/><label>注册邮箱</label></div>
                <div class="dl_jm_two dl_zhmmdown">
                    <a href="javascript:;" id="send">找回密码</a>
                </div>
            </div>
        </div>
    </div>
