        ...
        <div class="lm_oneleft">
            <div class="video">
                ...
                <div class="lmlistbox">
                    ...
                    <div class="lmlist" style="height:30px; line-height:30px;"><a href="<?php echo Yii::app()->createUrl('site/viewVideo', array('id' => $obj->id)); ?>" target="_blank"><?php echo $obj->title; ?></a><span><?php echo date('Y-m-d', $obj->date); ?></span></div>
                    <?php } ?>
                </div>
            </div>
            <div class="zczl" style=" margin-top:10px;">
                <div class="zczlone"><font color="#000000">立即注册获得以下资料</font></div>
