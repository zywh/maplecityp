    ...
    <div class="lm_onedown">
        <div class="lm_oneleft">
            <div class="video">
                ...
                <div class="youku"  style="width:262px; height:171px">
				
				<embed src="http://player.youku.com/player.php/sid/XMTU2MDE2NDk5Ng==/v.swf" allowFullScreen="true" quality="high" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
				
				</div>
                
				<div class="lmlistbox">
                    <?php foreach($video as $obj){ ?>
                    <div class="lmlist" style="height:30px; line-height:30px; border-bottom:1px dashed #8a8a8a;"><a href="<?php echo Yii::app()->createUrl('site/viewVideo', array('id' => $obj->id)); ?>" target="_blank"><?php echo $obj->title; ?></a><span><?php echo date('Y-m-d', $obj->date); ?></span></div>
                    <?php } ?>
                </div>
            </div>
            <div class="zczl">
                <div class="zczlone">立即注册获得以下资料</div>
                <div class="zczltwo" style="padding:10px 0 0 18px;">
...
?>
            <div class="lm_jd">
                <div class="lm_jdup">
                    <div class="lm_label"><span class="highlight">房源编号：<?php echo strtoupper($househaizai["ml_num"]); ?></div>
                    <!--<a href="<?php echo Yii::app()->createUrl('hotrecommend/more', array('city'=>$househaizai["municipality"])); ?>" class="more" target="_blank">更多项目</a> -->
                    <div class="cl"></div>
                </div>
                <div class="lm_jddown" title="<?php echo $househaizai["addr"]; ?>">
                
 <?php if($househaizai["house_image"]==""){?>
                                 <a href="<?php echo Yii::app()->createUrl('house/view',array('id'=>$househaizai["id"])); ?>"  target="_blank"><img src='/static/images/zanwu.jpg' width="338" height="266"></a>
                      <?php }else{?>
 <a href="<?php echo Yii::app()->createUrl('house/view', array('id'=>$househaizai["id"])); ?>" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl;?>/<?php echo $househaizai["house_image"]; ?>" width="338" height="266" /></a>
                      <?php }?>
                    ...
                    <div class="lm_jd_tc">
                        <div class="lm_jd_tcbox">
                            <div class="lm_jd_wzup">
                                <span>地区：<?php echo $househaizai["addr"]; ?></span>
                                <span>价格：<font color="#CC6600"><?php echo $househaizai["lp_dol"]/10000; ?></font>万加币</span>
                            </div>
                            <a href="<?php echo Yii::app()->createUrl('house/view', array('id'=>$househaizai["id"])); ?>" target="_blank">[详细]</a>
                        </div>
                    </div>
                </div>
            </div>
...
foreach($resultshazai as $key => $househaizai){
            ...
            <div class="lm_twojs_one lm_twojs_two">
                <div class="lm_twojs_one_right">
                    <div class="lm_twojs_title">地区：<?php echo $househaizai["addr"]; ?></div>
                    <div class="lm_twojs_info"><span>简介：</span><?php echo $househaizai["lp_dol"]/10000; ?>万加币/<?php echo $househaizai["ml_num"]; ?><br /><?php echo strip_tags($househaizai["ad_text"]); ?></div>
                    <a class="more" href="<?php echo Yii::app()->createUrl('enjoy/view', array('id'=>$househaizai["id"])); ?>" target="_blank">[详细]</a>
                </div>
            ...
            <div class="lm_twojs_one">
                ...
                <div class="lm_twojs_one_right">
                    ...
                    <a class="more" href="<?php echo Yii::app()->createUrl('house/view', array('id'=>$househaizai["id"])); ?>" target="_blank">[详细]</a>
                </div>
                <div class="cl"></div>
            </div>
            <?php }} ?>
...
<div class="lm_four">
    ...
    <div class="lm_fourdown">
        <div class="lm_four_banner"><a href="#"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/index/tl_1.jpg" /></a></div>
...
<!--			<div class="lm_four_banner"><a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>17)); ?>"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/index/b_3.jpg" /></a></div>-->
			<div class="lm_four_banner"><a href="#"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/index/tl_2.jpg" /></a></div>
        <div class="lm_five_down_news">
            <div class="lm_five_left">
                 <div class="lm_five_left_label">
...
<div class="lm_five">
    ...
    <div class="lm_five_down" style="margin-top:-50px;">
			<div class="lm_four_banner"><a href="#"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/index/tl_3.jpg" /></a></div>
        <div class="lm_five_down_news">
            <div class="lm_five_left">
                 <div class="lm_five_left_label">
...
<div class="lm_five">
    ...
    <div class="lm_five_down" style="margin-top:-50px;">
			<div class="lm_four_banner"><a href="#"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/index/tl_4.jpg" /></a></div>
        <div class="lm_five_down_news">
            <div class="lm_five_left">
                 <div class="lm_five_left_label">
