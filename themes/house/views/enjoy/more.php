...
<div class="cl"></div>
<div class="nytb_dz">
    <a href="<?php echo Yii::app()->createUrl('site/index'); ?>">首页</a> > <a href="<?php echo Yii::app()->createUrl('enjoy/index'); ?>">豪宅鉴赏</a> > <span>更多-<?php echo $cur_city->name; ?></span>
</div>
<!-- 地址结束 -->
<!-- 豪宅鉴赏开始 -->
<div class="enjoy">
        ...
        <div class="enjoyup_tab">
            <div class="enjoyup_tabup">
                ...
                foreach($subject_list as $k => $obj){
                    if($k == 0){
                        ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$obj->city_id)); ?>" data-index="<?php echo $obj->city_id; ?>"><?php echo $obj->city->name; ?></a>|
                    <?php }elseif(($k + 1) == $num){ ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$obj->city_id)); ?>" data-index="<?php echo $obj->city_id; ?>"><?php echo $obj->city->name; ?></a>
                    <?php }else{ ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$obj->city_id)); ?>" data-index="<?php echo $obj->city_id; ?>"><?php echo $obj->city->name; ?></a>|
    ...
    <div class="enjoydown">
        <div class="enjoydownlabel enjoydownlabel_two">
            ...
            <div class="enjoydownlabel_right">
                ...
                <?php if(!empty($time_sort)){
                    if($time_sort == 'DESC'){
                        ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort'=>'ASC')); ?>" class="pxfs1">时间</a>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort' => 0, 'price_sort'=>'DESC')); ?>">总价</a>
                    <?php }else{ ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort'=>'DESC')); ?>" class="pxfs2">时间</a>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort' => 0, 'price_sort'=>'DESC')); ?>">总价</a>
                    <?php } ?>
                <?php }elseif(!empty($price_sort)){
                    if($price_sort == 'DESC'){
                        ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort'=>'DESC')); ?>">时间</a>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort' => 0, 'price_sort'=>'ASC')); ?>" class="pxfs1">总价</a>
                    <?php }else{ ?>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort'=>'DESC')); ?>">时间</a>
                        <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort' => 0, 'price_sort'=>'DESC')); ?>" class="pxfs2">总价</a>
                    <?php } ?>
                <?php }else{ ?>
                    <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort'=>'DESC')); ?>">时间</a>
                    <a href="<?php echo Yii::app()->createUrl('enjoy/more', array('city'=>$cur_city->id, 'time_sort' => 0, 'price_sort'=>'DESC')); ?>">总价</a>
                ...
                <?php foreach($house_list as $house){ ?>
                    <div class="enjoydown_list">
                        ...
                        <div class="enjoydown_list_info" style="display:block;">
                            ...
                            <span class="enjoy_zj">总价：<i><?php echo $house->lp_dol / 10000; ?></i>万加币</span>
                        </div>
                        <div class="enjoydown_list_xx" style="display:none;">
                            <a href="<?php echo Yii::app()->createUrl('house/view',array('id'=>$house->id)); ?>" target="_blank">
                                <span class="titlespan">MLS:<?php echo $house->ml_num; ?></span>
                            <span style="height: 120px; overflow: hidden;">
                                简介<br /><?php echo strip_tags($house->ad_text); ?>
                            </span>
                            <span>
                                 地址<br /><?php echo $house->addr; ?>
                            </span>
                            <span>
                                 总价<br /><i><?php echo $house->lp_dol /10000; ?></i>万加币
                            </span>
                            </a>
                        </div>
                    </div>
