...
<div class="fyss">
   ...
   <div class="fyss_tjlist" id="cd1">
            ...
            <div class="fyss_tjlistcenter"><a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => 0, 'cd2' => 0, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" class="fyss_tj_cur" data-index="0">不限</a></div>
            <div class="fyss_tjlistright fyss_tjlistone"  style="position:relative; overflow:hidden; height:28px;">
              
               <?php foreach ($city_list as $city) { ?>
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $city['id'], 'cd2' => 0, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="<?php echo $city['id']; ?>">
                        <?php echo $city['name']; ?>
                    </a>
                <?php } ?>
        ...
        <div class="fyss_tjlist" id="cd2">
            ...
            <div class="fyss_tjlistcenter"><a  class="fyss_tj_cur" href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => 0, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="0">不限</a></div>

            <div class="fyss_tjlistright" style="position:relative; overflow:hidden; height:28px;">
                <?php foreach ($district_list as $district) { ?>
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $district['id'], 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="<?php echo $district['id']; ?>"><?php echo $district['name']; ?></a>
                <?php } ?>
             <div class="more_dd">更多</div>
<script>
$(document).ready(function() {
    $(".more_dd").click(function(){
        ...
        <div class="fyss_tjlist" id="cd3">
            ...
            <div class="fyss_tjlistcenter"><a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => 0, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" class="fyss_tj_cur" data-index="0">不限</a></div>
            <div class="fyss_tjlistright fyss_tjlistone">

                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => 1, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="1">最新</a>

                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => 2, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="2">一个月</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => 3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="3">三个月</a>
            </div>
            <div class="cl"></div>
        </div>
        ...
        <div class="fyss_tjlist" id="cd4">
            ...
            <div class="fyss_tjlistright fyss_tjlistone">
                <?php foreach ($propertyType_list as $propertyType) { ?>
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $propertyType['id'], 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10, 'cd11' => $cd11, 'cd12' => $cd12)); ?>" data-index="<?php echo $propertyType['id']; ?>"><?php echo $propertyType['name']; ?></a>
                <?php } ?>
            </div>
            <div class="cl"></div>
        </div>
        ...
        <div class="fyss_tjlist" id="cd6">
            ...
            <div class="fyss_tjlistright">
                <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 1, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="1" data-value="0,700">700以下</a>
                <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 2, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="2" data-value="700,1100">700-1100</a>
                <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 3, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="3" data-value="1100,1500">1100-1500</a>
                <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 4, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="4" data-value="1500,2000">1500-2000</a>
                
          <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 5, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="5" data-value="2000,2500">2000-2500</a>
          
          <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="6" data-value="2500,3000">2500-3000</a>
         
          <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 7, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="7" data-value="3000,3500">3000-3500</a>
                  
          <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 8, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="8" data-value="3500,4000">3500-4000</a>
                  
                <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => 9, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => $cd10)); ?>" data-index="9" data-value="4000,0">4000以上</a>
        ...
        <div class="fyss_tjlist" id="cd10">
            ...
            <div class="fyss_tjlistcenter"><a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 0)); ?>" class="fyss_tj_cur" data-index="0">不限</a></div>
            <div class="fyss_tjlistright fyss_tjlistone">

                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 1)); ?>" data-index="1">临水</a>

                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 2)); ?>" data-index="2">临塘</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 3)); ?>" data-index="3">临溪</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 4)); ?>" data-index="4">临河</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 5)); ?>" data-index="5">临湖(海)</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 6)); ?>" data-index="6">临游艇停靠去</a>
            </div>
            <div class="cl"></div>
        </div>
        ...
        <div class="fyss_tjlist" id="cd11">
            ...
            <div class="fyss_tjlistright fyss_tjlistone">
                    ...
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 1)); ?>" data-index="1">临树林</a>

                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 2)); ?>" data-index="2">临森林</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 3)); ?>" data-index="3">临绿色保护带</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 4)); ?>" data-index="4">临森林保护区</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 4)); ?>" data-index="4">临谷</a>
            </div>
            <div class="cl"></div>
        </div>
        ...
        <div class="fyss_tjlist" id="cd12">
            ...
            <div class="fyss_tjlistright fyss_tjlistone">
                    ...
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 1)); ?>" data-index="1">学校</a>

                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 2)); ?>" data-index="2">医院</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 3)); ?>" data-index="3">公共交通</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 4)); ?>" data-index="4">高尔夫球场</a>
                    
                    <a href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' =>$cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 4)); ?>" data-index="4">图书馆</a>
            </div>
            <div class="cl"></div>
        </div>
...
<div class="syss_picone"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/house/b_4.jpg" width="1030" /></div>
<!-- 房源搜索结束 -->
...
<?php } ?>
      ...
      <div class="syss_pxtwo">第<span>1</span>页&nbsp;&nbsp; 共<span>35</span>页</div>
    ...
    <div class="syss_fclist">
      <div class="syss_fclist_right">
        ...
        <div class="syss_fctwo"><a href="#" target="_blank">地址：<?php echo $house->addr; ?></a></div>
        <div class="syss_fctwo"><a href="#" target="_blank">地区：<?php echo $house->area; ?></a></div>
        <div class="syss_fcfour">
          <div class="syss_fcfour_one" style="color:grey">房屋面积：<?php echo $house->sqft; ?>平方英尺</div>
          <div class="syss_fcfour_one" style="color:grey">物业类型：<?php echo $house->type_own1_out; ?></div>
          <div class="syss_fcfour_one" style="color:grey">挂牌价格：<span><?php echo $house->lp_dol/10000; ?>万加币</span></div>
          <div class="syss_fcfour_one" style="color:grey">挂牌时间：<?php echo $house->pix_updt; ?></div>
        </div>
        <div class="syss_fcfive">
          <div class="syss_fcfiveone"> <span class="syss_btn"><a href="<?php echo Yii::app()->createUrl('house/view', array('id' => $house->id)); ?>"><font color="#FFFFFF">点击查看详情</font></a></span> </div>
          <div class="syss_fcfiveone"> <span class="syss_btn"><a href="<?php echo Yii::app()->createUrl('house/view', array('id' => $house->id)); ?>#fydt" target="_blank"><font color="#FFFFFF">查看地图</font></a></span> </div>
          <div class="cl"></div>
        </div>
        <div class="syss_fcfive">
          <div class="syss_fcfiveone"> <span class="syss_fc_fj"><?php echo $house->br; ?></span> <span class="syss_fc_cs"><?php echo $house->bath_tot; ?></span> </div>
          <div class="syss_fcfivetwo"> <a href="javascript:void(0);" class="syss_fc_sc <?php if (in_array($house->id, $collection_list)) {
        echo 'collected';
    } ?>" data-id="<?php echo $house->id; ?>">收藏</a> <a href="javascript:void(0);" class="syss_fc_db" id="<?php echo $house->id; ?>" data-img="<?php echo $house->house_image; ?>">对比</a> </div>
          <div class="cl"></div>
        </div>
        <div class="syss_fcthree">
                        ...
                        for ($i = 0; $i < $image_num; $i++) {
                            ?>
          <div class="syss_fcthree_pic">
          <img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $image_list[$i]['file']; ?>" width="92" height="73"></div>
           <?php } }?>
          <div class="cl"></div>
        </div>
      </div>
      <div class="syss_fclist_left"> 
      <?php if($house->house_image==""){?>
      <a href="<?php echo Yii::app()->createUrl('house/view', array('id' => $house->id)); ?>" target="_blank"><img src='/static/images/zanwu.jpg' width="396" height="307"></a>
      <?php }else{?>
      <a href="<?php echo Yii::app()->createUrl('house/view', array('id' => $house->id)); ?>" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $house->house_image; ?>" width="396" height="307" /></a>
      <?php }?>
      </div>
      <div class="cl"></div>
    </div>
  ...
  <div class="syss_jg_right">
    <div class="zczl">
      ...
      <div class="zczltwo"> <span>1.加国房产投资报告</span> <span>2.海外移民指南</span> <span>3.加国留学指南</span> </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if (cd1 == 0 && cd2 == 0 && cd3 == 0 && cd4 == 0 && cd5 == 0 && cd6 == 0 && cd7 == 0 && cd8 == 0 && cd9 == 0 && cd10 == 0)
            $("#clear_selected").hide();
        ...
        if (cd10)
            $("#selected").append('<a class="fyss_qrtj_list" href="<?php echo Yii::app()->createUrl('house/index', array('cd1' => $cd1, 'cd2' => $cd2, 'cd3' => $cd3, 'cd4' => $cd4, 'cd5' => $cd5, 'cd6' => $cd6, 'cd7' => $cd7, 'cd8' => $cd8, 'cd9' => $cd9, 'cd10' => 0)); ?>">' + cd10_text + '</a>');
        ...
        $("#confirm").click(function() {
            ...
            window.location.href = "<?php echo Yii::app()->createUrl('house/index'); ?>&cd1=<?php echo $cd1; ?>&cd2=<?php echo $cd2; ?>&cd3=<?php echo $cd3; ?>&cd4=<?php echo $cd4; ?>&cd5=0&cd6=<?php echo $cd6; ?>&cd7=<?php echo $cd7; ?>&cd8=<?php echo $cd8; ?>&cd9=<?php echo $cd9; ?>&cd10=<?php echo $cd10; ?>";
        });
