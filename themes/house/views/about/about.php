...
<!-- nybanner结束-->
 ...
 <?php if($_GET["id"]=="27"){?>
 <span style="font-size:14px;">枫之都简介</span> 
 <?php }elseif($_GET["id"]=="38"){?>
 <span style="font-size:14px;">枫之都俱乐部</span> 
 <?php }elseif($_GET["id"]=="28"){?>
 <span style="font-size:14px;">我们的优势</span> 
 <?php }elseif($_GET["id"]=="30"){?>
 <span style="font-size:14px;">联系我们</span> 
 <?php }elseif($_GET["id"]=="31"){?>
 <span style="font-size:14px;">人才招募</span> 
 <?php }?>
 </div>
