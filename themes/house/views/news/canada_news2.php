...
<div class="nytb_dz" style="width:980px;">
    <a href="<?php Yii::app()->createUrl('site/index'); ?>">首页</a> > <a href="<?php echo Yii::app()->createUrl('news/canadaNews'); ?>"><?php echo $this->getCatalogName(1); ?></a> > <span><a style="color:#FF3300"><?php echo $this->getCatalogName($catalog_id); ?></a></span>
</div>
<!-- 地址结束 -->
<!-- 房产资讯开始 -->
...
<?php //if($_GET[catalog_id]!=17){?>
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left"><?php echo $this->getCatalogName(17); ?></div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>17)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>17)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(17); ?>" width="94" height="94"/></a></div>
...
<?php //if($_GET[catalog_id]!=18){?>
                        <div class="lm_four_right_newslist lm_four_right_newslist_two">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left"><?php echo $this->getCatalogName(18); ?></div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>18)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>18)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(18); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
...
<?php //if($_GET[catalog_id]!=43){?>
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left">枫之都学子俱乐部</div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>43)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>43)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(43); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
...
<?php //if($_GET[catalog_id]!=23){?>
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left"><?php echo $this->getCatalogName(23); ?></div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>23)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews2', array('catalog_id'=>23)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(23); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
                    ...
                    <div class="jgzx_rdxw">
                        <div class="jgzx_rdxw_up">
                            ...
                            <div class="jgzx_rdxw_up_right">
                                ...
                                <span><?php echo $special_news->summary; ?>... <a href="<?php echo Yii::app()->createUrl('news/canadaNewsView',array('id'=>$special_news->id)); ?>" class="jgzx_ljxx" target="_blank">查看详细</a></span>
