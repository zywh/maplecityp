...
<div style="text-align:center; height:166px; background-color:#ead9d1">
 ...
 <div class="nytb_dz" style="width: 982px; padding-bottom:0px;"> <a href="<?php echo Yii::app()->createUrl('site/index'); ?>">首页</a> &gt; <span style="font-size:14px;">新闻 • 资讯</span> </div>

<!-- 房产资讯开始 -->
<div class="fyxq">
    <div class="fyxqdown zx_zwy">
        <div class="fyxqdown_left" style="border-right:#FFFFFF 1px solid;padding-right:0px;width: 693px;">
            <div class="jgzx_down">
                <div class="jgzx_down_left">
                    <div class="lm_five_left_label">
                        <div class="jgzx_label_left">社会热点</div>
                        <a href="<?php echo Yii::app()->createUrl('news/canadaNews', array('catalog_id'=>41)); ?>" class="moretwo">更多>></a>
                        <div class="cl"></div>
                    </div>
                    ...
                    <div class="lm_four_center">
                        <div class="lm_four_center_title"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/news/xlm_1.jpg" /></div>
                    ...
                    <div class="lm_four_right">
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left"><?php echo $this->getCatalogName(7); ?></div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews', array('catalog_id'=>7)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                        ...
                        <div class="lm_four_right_newslist lm_four_right_newslist_two">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left"><?php echo $this->getCatalogName(8); ?></div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews', array('catalog_id'=>8)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                        ...
                        <div class="lm_four_right_newslist lm_four_right_newslist_two">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left">加国新闻</div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews', array('catalog_id'=>6)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews', array('catalog_id'=>6)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(6); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
                                        <?php 
$db = Yii::app()->db;
$sqlhaozi = "select * from h_post where catalog_id=6 limit 0,5";
