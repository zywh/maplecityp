...
<?php //if($_GET[catalog_id]!=19){?>
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left">移民政策</div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>19)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>19)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(19); ?>" width="94" height="94"/></a></div>
...
<?php //if($_GET[catalog_id]!=20){?>
                        <div class="lm_four_right_newslist lm_four_right_newslist_two">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left">移民快讯</div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>20)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>20)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(20); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
...
<?php //if($_GET[catalog_id]!=24){?>
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left">移民生活</div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>24)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>24)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(24); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
...
<?php //if($_GET[catalog_id]!=45){?>
                        <div class="lm_four_right_newslist">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left">移民讲座</div>
                                <a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>45)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                            <div class="lm_four_news_down">
                                <div class="lm_four_news_down_left"><a href="<?php echo Yii::app()->createUrl('news/canadaNews3', array('catalog_id'=>45)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(45); ?>" width="94" height="94"/></a></div>
                                <div class="lm_four_news_down_right">
                                    <div class="lm_four_news_down_info">
 <?php 
$db = Yii::app()->db;
$sqlhaozi = "select * from h_post where catalog_id=45 limit 0,5";
                    ...
                    <div class="jgzx_rdxw">
                        <div class="jgzx_rdxw_up">
                            ...
                            <div class="jgzx_rdxw_up_right">
                                ...
                                <span><?php echo $special_news->summary; ?>...<a href="<?php echo Yii::app()->createUrl('news/canadaNewsView',array('id'=>$special_news->id)); ?>" class="jgzx_ljxx" target="_blank">详细</a></span>
