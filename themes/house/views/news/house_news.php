...
<div style="text-align:center; height:166px; background-color:#ead9d1">
     <img src="/themes/house/news/images_index/ban.jpg"/>
</div>
<div style="height:10px; clear:both"></div>
<style>
.syljcont a:hover{ color:#FF6600}
.jgzx_rdxw_up_right a:hover{ color:#FF6600}
</style>
<!-- 地址开始 -->
<div class="cl"></div>
<div class="nytb_dz" style="width:980px;">
    <a href="<?php Yii::app()->createUrl('site/index'); ?>">首页</a> > <a href="<?php echo Yii::app()->createUrl('news/houseNews'); ?>"><?php echo $this->getCatalogName(5); ?></a> > <span style="font-size:14px;"><?php echo $this->getCatalogName($catalog_id); ?></span>
</div>
<!-- 地址结束 -->
<!-- 房产资讯开始 -->
<div class="fyxq"  style="margin-top:0px;">
    <div class="jgzx_up" style="display:none">
        ...
        <div class="fyxqdown_left" style="width:693px;">
            <div class="jgzx_down">
                <div class="jgzx_down_left" >
                    ...
                    <div class="jgzx_down_xqfzx">
                        <div class="lm_five_left" style="margin-bottom:0px;">
                            <div class="lm_five_left_label">
                                <div class="jgzx_label_left"><?php echo $this->getCatalogName(11); ?></div>
                                <a href="<?php echo Yii::app()->createUrl('news/houseNews', array('catalog_id'=>11)); ?>" class="moretwo">更多>></a>
                                <div class="cl"></div>
                            </div>
                                             <div class="lm_five_center_pic"><a href="<?php echo Yii::app()->createUrl('news/houseNews', array('catalog_id'=>11)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(11); ?>" width="290" height="88" border="0" /></a></div>
...
<!--                                <div class="lm_five_left_news_up">
                                    <div class="lm_five_left_news_title"><a href="<?php echo Yii::app()->createUrl('house/index',array('cd1'=>0,'cd2'=>0,'cd3'=>1,'cd4'=>0,'cd5'=>0,'cd6'=>0,'cd7'=>0,'cd8'=>0,'cd9'=>0,'cd10'=>0)); ?>">最新学区房介绍</a></div>
                                </div> -->
                    ...
                    <div class="lm_five_right" >
                        <div class="lm_five_left_label" style="margin-bottom:0px;">
                            <div class="jgzx_label_left"><?php echo $this->getCatalogName(12); ?></div>
                            <a href="<?php echo Yii::app()->createUrl('news/houseNews', array('catalog_id'=>12)); ?>" class="moretwo">更多>></a>
                            <div class="cl"></div>
                        </div>
                 <div class="lm_five_center_pic"><a href="<?php echo Yii::app()->createUrl('news/houseNews', array('catalog_id'=>12)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(12); ?>" width="290" height="88" border="0" /></a></div>
                    ...
                    <div class="lm_five_right" >
                        <div class="lm_five_left_label" style="margin-bottom:0px;">
                            <div class="jgzx_label_left">房产资讯</div>
                            <a href="index.php?r=news/houseNews&catalog_id=10" class="moretwo">更多>></a>
                            <div class="cl"></div>
                        </div>
                        <div class="lm_five_center_info">
                            <?php foreach($house_zixun as $obj){ ?>
                            <div class="lm_five_center_list house_hotspots_line">
                                <a href="<?php echo Yii::app()->createUrl('news/houseNewsView', array('id'=>$obj->id)); ?>" target="_blank" title="<?php echo $obj->title; ?>" class="house_hotspots">· <?php echo $obj->title; ?></a> <span><?php 
					if($obj->last_update_time==0){
					echo "[".date('Y-m-d', $obj->create_time)."]"; 
                    ...
                    <div class="lm_five_right">
                        <div class="lm_five_left_label" style="margin-bottom:0px;">
                            <div class="jgzx_label_left"><?php echo $this->getCatalogName(13); ?></div>
                            <a href="<?php echo Yii::app()->createUrl('news/houseNews', array('catalog_id'=>13)); ?>" class="moretwo">更多>></a>
                            <div class="cl"></div>
                        </div>
                        <div class="lm_five_right_up">
                 <div class="lm_five_center_pic"><a href="<?php echo Yii::app()->createUrl('news/houseNews', array('catalog_id'=>13)); ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo $this->getCatalogImage(13); ?>" width="290" height="88" border="0" /></a></div>
                            <div class="cl"></div>
                        </div>
                    ...
                    <div class="jgzx_rdxw">
                        <div class="jgzx_rdxw_up">
                            ...
                            <div class="jgzx_rdxw_up_right">
                                <a href="<?php echo Yii::app()->createUrl('news/houseNewsView',array('id'=>$special_news->id)); ?>" class="jgzx_title" title="<?php echo $special_news->title; ?>" target="_blank"><?php echo $special_news->title; ?></a>
                                    <span><?php echo $special_news->summary; ?>...<a href="<?php echo Yii::app()->createUrl('news/houseNewsView',array('id'=>$special_news->id)); ?>" class="jgzx_ljxx" target="_blank">了解详细</a></span>
                        ...
                        <div class="jgzx_rdxw_down">
                            <?php foreach($more_news as $obj){ ?>
                                <div class="lm_five_center_list">
                                    <a href="<?php echo Yii::app()->createUrl('news/houseNewsView', array('id'=>$obj->id)); ?>" target="_blank" title="<?php echo $obj->title; ?>">· <?php echo $obj->title; ?></a> <span><?php 
					if($obj->last_update_time==0){
					echo "[".date('Y-m-d', $obj->create_time)."]"; 
					}else{
					echo "[".date('Y-m-d', $obj->last_update_time)."]"; 
                      ...
                      <?php }?>
                                                         ...
                                                         <div class="hot_fr">
                                                               <p><?php echo $househaizai["addr"]; ?><br />
                                                                 ...
                                                                 <font color="#CC6600"><?php echo $househaizai["lp_dol"]/10000;?></font>万加元
                                                               </p>
                                                         </div>
