    ...
    <div class="mapobx">
        ...
        <div class="mapright">
			...
			<div class="mapone">
                ...
                <div class="mapone">
                    <div class="map_lm">卧室：<span id="room_choose">不限</span></div>
...
<script>
	...
	$(function(){	
		...
		var p = $("#google_map").offset();
		//console.log( "left: " + p.left + ", top: " + p.top );
    ...
    var changeMap = function() {
		...
		var mapHeight = $("#google_map").height();
		var mapWidth = $("#google_map").width();
		var gridx = Math.ceil(mapWidth/gridSize);
		var gridy = Math.ceil(mapHeight/gridSize);
		console.log("H:" + mapHeight + "W:" + mapWidth + "Grid-" + gridx +":" + gridy);
				...
				if (!data.IsError) {
					...
					if ((markerType == 'city') || (markerType == 'grid')) {
						for (var p in data.Data.AreaHouseCount) {
							...
							googleMap.setContentCount(map,areaHouse.GeocodeLat, areaHouse.GeocodeLng, areaHouse.HouseCount.toString(), areaHouse.NameCn);
