...
<table class="form_table">
  ...
  <tr >
    <td><?php echo $form->textArea($model,'cityname',array('rows'=>1, 'cols'=>30, 'class'=>'validate[required]')); ?></td>
  </tr>
  ...
  <tr>
    <td>
      <div>
        <p><a href="javascript:uploadifyAction('LayoutFiles','layoutList')" ><img src="<?php echo $this->_baseUrl?>/static/admin/images/create.gif" align="absmiddle">添加布局图片</a></p>
        <ul id="LayoutFiles">
  ...
  <tr >
    <td><?php echo $form->textArea($model,'developer_intro',array('rows'=>5, 'cols'=>90)); ?></td>
  </tr>
  <tr>
