...
function uploadifyAction(fileField,inputName) {
    $.Zebra_Dialog('', {
        source: {
            'iframe': {
                'src': '<?php echo $this->createUrl('uploadify/basic&inputname=')?>' + inputName,
                'height': 300,
                'name': 'bagecms_com',
                'id': 'bagecms_com'
            }
